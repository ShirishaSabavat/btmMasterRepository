...
import { Facebook, Twitter, Mail, GitHub, Send, Star } from 'react-feather'
import '@styles/base/pages/page-auth.scss'
import {Grid, Stack, Button, Card, Avatar, CardContent, CardHeader, CardMedia, Typography, Chip} from '@mui/material'
        ...
        <Card onClick={() => history.push(`course/${props.data._id}`)} className="ml-1 mb-3 pointer" sx={{ maxWidth: 345 }}>
            ...
            />
             <div style={{position: "absolute", top: '10px', right: "4px"}}>
                <Chip icon={<Star size={15} className='align-middle' />}  label="Featured" color="success" size="small" />
             </div>
            <CardContent>
